...
#exec ${JAVA} ${KS_APP_DIR} ${KS_LOG4J_OPTS} -cp ${CLASSPATH} com.unimas.kstream.KsServer "$@"
nohup ${JAVA} ${KS_APP_DIR} ${KS_LOG4J_OPTS} -cp ${CLASSPATH}  com.unimas.kstream.KsServer "$@" > "$log_dir/ks.out" 2>&1 < /dev/null &
