...
public class DeleteTask extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        Map<String, String> params = KJson.readValue(body.toString(),
                new TypeToken<HashMap<String, String>>() {
                }.getType());
        String app_id = params.get("application_id");
//        String app_name = params.get("application_name");
        Path dir = JettyServer.app_dir.resolve(app_id);
        Files.walkFileTree(dir, new EmptyDir());
        JettyServer.caches.remove(app_id);
