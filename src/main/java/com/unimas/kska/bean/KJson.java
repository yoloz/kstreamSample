...
public class KJson {
    ...
    public static Map<String, String> readStringValue(String value) throws IOException {
        try {
            return kJson.fromJson(value, new TypeToken<Map<String, String>>() {
            }.getType());
    ...
    public static String writeValue(Object value, Type typeOfT) throws IOException {
        try {
            return kJson.toJson(value, typeOfT);
        } catch (JsonParseException e) {
            throw new IOException(e);
        }
    }
    ...
    public static String writeValueAsString(Map<String, Object> value) throws IOException {
        try {
            return writeValue(value, new TypeToken<Map<String, Object>>() {
            }.getType());
        } catch (JsonParseException e) {
            throw new IOException(e);
        }
