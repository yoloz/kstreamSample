...
public abstract class Operation implements KUtils {
    ...
    Object through(Object object, String throughTopic) {
        if (object instanceof KTable)
            return ((KTable<String, String>) object).through(Serdes.String(), Serdes.String(), throughTopic);
        else return ((KStream<String, String>) object).through(Serdes.String(), Serdes.String(), throughTopic);
    }
