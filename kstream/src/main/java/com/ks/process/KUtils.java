...
public class KUtils {
    ...
    public static String getNewValueFromValue(String value, List<String> terms, boolean append)
            throws IOException {
     ...
     */
    public static String getNewKeyFromValue(String key, String value, String keyType, List<String> terms,
     ...
     */
    public static String nonNullEmpty(Properties properties, String key) throws KConfigException {
     ...
     */
    public static ImmutableList<String> split(final String str, final String separator) {
     ...
     */
    public static String concat(final String spacer, String... str) {
     ...
     * @return string {@link String}
     */
    public static String concat(final String spacer, Iterator<String> iterator) {
